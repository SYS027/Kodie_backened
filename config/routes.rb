Rails.application.routes.draw do
  ...
  namespace 'api' do
    namespace 'v1' do
      ...
      post 'get_property_details_after_archieve_by_id', to: 'property#get_property_details_After_archieve_by_id'
      post 'get_property_details_by_filter', to: 'property#get_Details_by_filter'
      post 'archieve_property', to: 'property#add_property_details_archieve'
      ...
      put 'update_property_images_video_details', to: 'step1#update_property_images_video'
    end
  end
end
